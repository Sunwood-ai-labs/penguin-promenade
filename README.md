![Penguin Promenade header](docs/images/header.png)
...
5. Look out for the smaller animated town penguins, which shuffle into slightly different spots each run.
...
- Other penguin WebPs are unpacked into frame sequences with `uv + Pillow` and reused as idle, look-around, wave interactions, and smaller ambient town characters with light random placement.
